...
class  get_set(object):
    def __init__(self,student_id,desk_id):
        ...
        self.start='2018-'+str(month)+'-'+str(days)+'+'+'12:00'  #预约起始时间
        self.end='2018-'+str(month)+'-'+str(days)+'+'+'16:00'    #预约结束时间
        self.start_time='1200'    #此处为开始修改时间，例如8:00应该改成800，21:30修改为2130
        self.end_time='1600'      #此处为结束修改时间，修改方式同上
...
if __name__=='__main__':
    ...
    # stdudent_2=get_set(student_id=000000000,desk_id=0000000)   #在这里输入学号和座位号
